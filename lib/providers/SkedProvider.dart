...
import '../SkedWebSocketService.dart';
...
class SkedProvider extends ChangeNotifier {
  ...
  Future<Sked> updateSked(Sked sked) async {
    try {
      ...
      // только отправка по сокету без перерисовки
  ...
  // Stream<bool> watchAvailability(int skedId) {
  //   return _wsService.availabilityUpdates(skedId);
  // }
