...
class _SkedsScreenState extends State<SkedsScreen> {
  ...
  void _onDepartmentSelected(int? departmentId) {
    ...
    // Вместо прямого присвоения используем существующие методы провайдера
                    ...
                    onPressed: () async {
                      ...
                      try {
                        allSkeds = await provider.fetchAllSkedsRaw(
                          departmentId: _selectedDepartmentId, // Используем локальное состояние
                        );
                        ...
                        if (selected == 'print') {
                          await PrintService.printPdf(
                            ...
                            font: font,
                            fontBold: fontBold, employees: employeeProvider.employees,
