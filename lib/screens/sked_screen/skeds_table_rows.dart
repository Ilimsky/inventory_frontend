...
DataCell _buildDataCell(String text, double width, int maxLines, bool isMoved, bool isDeleted) {
  return DataCell(
    Container(
      width: width,
      child: Text(
        ...
        style: TextStyle(
          fontSize: 10,
          color: isDeleted ? Colors.grey : isMoved ? Colors.orange : null,
  ...
  return skeds.asMap().entries.map((entry) {
    ...
    return DataRow(
      ...
      cells: [
        ...
        _buildDataCell(dateFormat.format(sked.dateReceived), 55, 1, isMoved, false),
